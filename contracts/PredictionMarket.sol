...
contract PredictionMarket {
    ...
    function withdrawGain() external {
        ...
        require(gamblerBet > 0, 'you do not have any winner bet');
        ...
        betsPerGambler[msg.sender][Side.Rahul] = 0;
        betsPerGambler[msg.sender][Side.Modi] = 0;
